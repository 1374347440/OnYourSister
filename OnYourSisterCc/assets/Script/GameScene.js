...
cc.Class({
    ...
    onLoad() {
        ...
        if (GameConfig.MAIN_MENU_NUM == GameConfig.MainMenu.MainMenuNumLeft) {
            this.breakPlank[0] = new BreakPlank(0, -GameConfig.DEVICE_WIDTH / 2.0, -GameConfig.DEVICE_WIDTH / 2.0 + GameConfig.CARD_WIDTH / 2);
            this.node.addChild(this.breakPlank[0], 1, 1);
        } else if (GameConfig.MAIN_MENU_NUM == GameConfig.MainMenu.MainMenuNumRight) {
            this.breakPlank[1] = new BreakPlank(1, GameConfig.DEVICE_WIDTH / 2.0, -GameConfig.DEVICE_WIDTH / 2 + GameConfig.CARD_WIDTH / 2);
            this.node.addChild(this.breakPlank[1], 1, 1);
        } else if (GameConfig.MAIN_MENU_NUM == GameConfig.MainMenu.MainMenuNumBoth) {
            this.breakPlank[0] = new BreakPlank(0, -GameConfig.DEVICE_WIDTH / 2, -GameConfig.DEVICE_WIDTH / 2 + GameConfig.CARD_WIDTH / 2);
            this.breakPlank[1] = new BreakPlank(1, GameConfig.DEVICE_WIDTH / 2.0, -GameConfig.DEVICE_WIDTH / 2 + GameConfig.CARD_WIDTH / 2);
            this.node.addChild(this.breakPlank[0], 1, 1);
            this.node.addChild(this.breakPlank[1], 1, 1);
        }
