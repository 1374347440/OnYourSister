...
var BreakPlank = cc.Class({
    ...
    initUI(numbers, CardSpriteX, CardSpriteY) {
        ...
        if (this.number == 0) {
            this.cardArr[0] = new CardSprite(0, GameConfig.DEVICE_WIDTH / 2.0 - GameConfig.CARD_WIDTH, 0);
            this.cardArr[1] = new CardSprite(1, 0, GameConfig.DEVICE_WIDTH / 2 - GameConfig.CARD_WIDTH / 2);
            this.cardArr[2] = new CardSprite(1, -GameConfig.DEVICE_WIDTH / 2.0 + GameConfig.CARD_WIDTH / 2, 0);
            this.cardArr[3] = new CardSprite(1, 0, -GameConfig.DEVICE_WIDTH / 2.0 + GameConfig.CARD_WIDTH / 2);
            this.startCard = new CardSprite(2, GameConfig.DEVICE_WIDTH / 2.0 - GameConfig.CARD_WIDTH, 0);
